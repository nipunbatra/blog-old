...
There are a couple of apps I use for SSH.
* a-Shell
* Termius. I like the Termius interface a lot. Having easy to view stored connections via an intuitive GUI is great!
